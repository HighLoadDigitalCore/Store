...
namespace Smoking.telerik.App_Code
{
	...
	public partial class CMSPageSlider : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Data.Linq.Binary _Preview;
    ...
    partial void OnPreviewChanging(System.Data.Linq.Binary value);
    partial void OnPreviewChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Preview", DbType="VarBinary(MAX) NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public System.Data.Linq.Binary Preview
		{
			get
			{
    ...
    partial void OnPriorityChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreImporter_FilterItem", Storage="_FilterItems", ThisKey="ID", OtherKey="CharID")]
		...
		{
			this.SendPropertyChanging();
			entity.StoreImporter = this;
		}
		
		private void detach_FilterItems(FilterItem entity)
		{
			this.SendPropertyChanging();
			entity.StoreImporter = null;
		}
	}
	...
	public partial class FilterItem : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<StoreImporter> _StoreImporter;
    ...
    partial void OnVisibleChanged();
		...
		public FilterItem()
		{
			...
			this._StoreImporter = default(EntityRef<StoreImporter>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Help", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		public string Help
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CharID", DbType="Int NOT NULL")]
		public int CharID
		{
			get
			{
			...
			set
			{
				...
				{
					if (this._StoreImporter.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Open", DbType="Bit NOT NULL")]
		public bool Visible
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreImporter_FilterItem", Storage="_StoreImporter", ThisKey="CharID", OtherKey="ID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public StoreImporter StoreImporter
		{
			get
			{
				return this._StoreImporter.Entity;
			}
			set
			{
				StoreImporter previousValue = this._StoreImporter.Entity;
				if (((previousValue != value) 
							|| (this._StoreImporter.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._StoreImporter.Entity = null;
						previousValue.FilterItems.Remove(this);
					}
					this._StoreImporter.Entity = value;
					if ((value != null))
					{
						value.FilterItems.Add(this);
					...
					{
						this._CharID = default(int);
					}
					this.SendPropertyChanged("StoreImporter");
				}
			}
		}
