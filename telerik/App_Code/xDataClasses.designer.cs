...
[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="stroy-pereplat-net")]
...
public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserMessage", Storage="_UserMessages1", ThisKey="UserId", OtherKey="UserID")]
	public EntitySet<UserMessage> UserMessages1
	{
		get
		{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserMessage1", Storage="_UserMessages", ThisKey="UserId", OtherKey="Sender")]
...
public partial class Comment : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Comment_Comment", Storage="_Comment1", ThisKey="ParentCommentID", OtherKey="ID", IsForeignKey=true)]
...
public partial class UserMessage : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserMessage", Storage="_User1", ThisKey="UserID", OtherKey="UserId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
	public User User1
	{
		get
		{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserMessage1", Storage="_User", ThisKey="Sender", OtherKey="UserId", IsForeignKey=true)]
	public User User
	{
		get
		{
...
public partial class OrderDeliveryZone : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	public EntitySet<OrderDeliveryZone> OrderDeliveryZones
	{
		get
		{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="OrderDeliveryZone_OrderDeliveryRegion", Storage="_OrderDeliveryRegions1", ThisKey="ID", OtherKey="DistanceZoneID")]
	public EntitySet<OrderDeliveryRegion> OrderDeliveryRegions1
	{
		get
		{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="OrderDeliveryZone_OrderDeliveryRegion1", Storage="_OrderDeliveryRegions", ThisKey="ID", OtherKey="WeightZoneID")]
	...
	public OrderDeliveryZone OrderDeliveryZone1
	{
		get
		{
		...
		set
		{
						...
						|| (this._OrderDeliveryZone1.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.OrderDeliveryZones.Remove(this);
				}
				this._OrderDeliveryZone1.Entity = value;
				if ((value != null))
				{
					value.OrderDeliveryZones.Add(this);
				...
				this.SendPropertyChanged("OrderDeliveryZone1");
			}
		}
	}
...
public partial class OrderDeliveryRegion : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="OrderDeliveryZone_OrderDeliveryRegion", Storage="_OrderDeliveryZone1", ThisKey="DistanceZoneID", OtherKey="ID", IsForeignKey=true)]
	public OrderDeliveryZone OrderDeliveryZone1
	{
		get
		{
		...
		set
		{
						...
						|| (this._OrderDeliveryZone1.HasLoadedOrAssignedValue == false)))
			{
				...
				{
					this._OrderDeliveryZone1.Entity = null;
					previousValue.OrderDeliveryRegions1.Remove(this);
				}
				this._OrderDeliveryZone1.Entity = value;
				if ((value != null))
				{
					value.OrderDeliveryRegions1.Add(this);
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="OrderDeliveryZone_OrderDeliveryRegion1", Storage="_OrderDeliveryZone", ThisKey="WeightZoneID", OtherKey="ID", IsForeignKey=true)]
...
public partial class CMSPageVideo : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntityRef<CMSPageLang> _CMSPageLang;
	...
	{
		this._CMSPageCellView = default(EntityRef<CMSPageCellView>);
		this._CMSPageLang = default(EntityRef<CMSPageLang>);
		this._CMSPage = default(EntityRef<CMSPage>);
		OnCreated();
	}
	...
	public int LangID
	{
		...
		set
		{
			if ((this._LangID != value))
			{
				if (this._CMSPageLang.HasLoadedOrAssignedValue)
				{
					throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
				}
				this.OnLangIDChanging(value);
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CMSPageCellView_CMSPageVideo", Storage="_CMSPageCellView", ThisKey="ViewID", OtherKey="ID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
	public CMSPageCellView CMSPageCellView
	{
		get
		{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CMSPageLang_CMSPageVideo", Storage="_CMSPageLang", ThisKey="LangID", OtherKey="ID", IsForeignKey=true)]
	public CMSPageLang CMSPageLang
	{
		get
		{
			return this._CMSPageLang.Entity;
		}
		set
		{
			CMSPageLang previousValue = this._CMSPageLang.Entity;
			if (((previousValue != value) 
						|| (this._CMSPageLang.HasLoadedOrAssignedValue == false)))
			{
				this.SendPropertyChanging();
				if ((previousValue != null))
				{
					this._CMSPageLang.Entity = null;
					previousValue.CMSPageVideos.Remove(this);
				}
				this._CMSPageLang.Entity = value;
				if ((value != null))
				{
					value.CMSPageVideos.Add(this);
					this._LangID = value.ID;
				...
				this.SendPropertyChanged("CMSPageLang");
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CMSPage_CMSPageVideo", Storage="_CMSPage", ThisKey="CMSPageID", OtherKey="ID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
	public CMSPage CMSPage
	{
		get
		{
...
public partial class CMSPageLang : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CMSPageLang_CMSPageVideo", Storage="_CMSPageVideos", ThisKey="ID", OtherKey="LangID")]
	public EntitySet<CMSPageVideo> CMSPageVideos
	{
		get
		{
	...
	{
		this.SendPropertyChanging();
		entity.CMSPageLang = this;
	}
	
	private void detach_CMSPageVideos(CMSPageVideo entity)
	{
		this.SendPropertyChanging();
		entity.CMSPageLang = null;
	}
}
...
public partial class StoreCharacter : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreCharacter_FilterItem", Storage="_FilterItems", ThisKey="ID", OtherKey="CharID")]
...
public partial class StoreCategory : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<StoreCategory> _StoreCategories;
	...
	private EntityRef<StoreCategory> _StoreCategory1;
	...
	public StoreCategory()
	{
		...
		this._StoreCategories = new EntitySet<StoreCategory>(new Action<StoreCategory>(this.attach_StoreCategories), new Action<StoreCategory>(this.detach_StoreCategories));
		...
		this._StoreCategory1 = default(EntityRef<StoreCategory>);
		OnCreated();
	}
	...
	public System.Nullable<int> ParentID
	{
		...
		set
		{
			...
			{
				if (this._StoreCategory1.HasLoadedOrAssignedValue)
				{
					throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
				}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreCategory_StoreCategory", Storage="_StoreCategories", ThisKey="ID", OtherKey="ParentID")]
	public EntitySet<StoreCategory> StoreCategories
	{
		get
		{
		...
		set
		{
			this._StoreCategories.Assign(value);
		}
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreCategory_StoreCategory", Storage="_StoreCategory1", ThisKey="ParentID", OtherKey="ID", IsForeignKey=true)]
	public StoreCategory StoreCategory1
	{
		get
		{
			return this._StoreCategory1.Entity;
		}
		set
		{
			StoreCategory previousValue = this._StoreCategory1.Entity;
			if (((previousValue != value) 
						|| (this._StoreCategory1.HasLoadedOrAssignedValue == false)))
			{
				this.SendPropertyChanging();
				if ((previousValue != null))
				{
					this._StoreCategory1.Entity = null;
					previousValue.StoreCategories.Remove(this);
				}
				this._StoreCategory1.Entity = value;
				if ((value != null))
				{
					value.StoreCategories.Add(this);
				...
				this.SendPropertyChanged("StoreCategory1");
			}
		}
	}
	...
	private void attach_StoreCategories(StoreCategory entity)
	{
		this.SendPropertyChanging();
		entity.StoreCategory1 = this;
	}
	
	private void detach_StoreCategories(StoreCategory entity)
	{
		this.SendPropertyChanging();
		entity.StoreCategory1 = null;
	}
...
public partial class StoreProduct : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<StoreProductRelation> _StoreProductRelations1;
	...
	public StoreProduct()
	{
		...
		this._StoreCategoryRelations = new EntitySet<StoreCategoryRelation>(new Action<StoreCategoryRelation>(this.attach_StoreCategoryRelations), new Action<StoreCategoryRelation>(this.detach_StoreCategoryRelations));
		this._StoreProductRelations1 = new EntitySet<StoreProductRelation>(new Action<StoreProductRelation>(this.attach_StoreProductRelations1), new Action<StoreProductRelation>(this.detach_StoreProductRelations1));
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreProduct_StoreProductRelation", Storage="_StoreProductRelations1", ThisKey="ID", OtherKey="BaseProductID")]
	public EntitySet<StoreProductRelation> StoreProductRelations1
	{
		get
		{
			return this._StoreProductRelations1;
		}
		set
		{
			this._StoreProductRelations1.Assign(value);
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreProduct_StoreProductRelation1", Storage="_StoreProductRelations", ThisKey="ID", OtherKey="RelatedProductID")]
	...
	private void attach_StoreProductRelations1(StoreProductRelation entity)
	{
		this.SendPropertyChanging();
		entity.StoreProduct1 = this;
	}
	
	private void detach_StoreProductRelations1(StoreProductRelation entity)
	{
		this.SendPropertyChanging();
		entity.StoreProduct1 = null;
	}
...
public partial class StoreProductRelation : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntityRef<StoreProduct> _StoreProduct1;
	...
	{
		this._StoreProduct1 = default(EntityRef<StoreProduct>);
		this._StoreProduct = default(EntityRef<StoreProduct>);
		OnCreated();
	}
	...
	public int BaseProductID
	{
		...
		set
		{
			...
			{
				if (this._StoreProduct1.HasLoadedOrAssignedValue)
				{
					throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
				}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreProduct_StoreProductRelation", Storage="_StoreProduct1", ThisKey="BaseProductID", OtherKey="ID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
	public StoreProduct StoreProduct1
	{
		get
		{
			return this._StoreProduct1.Entity;
		}
		set
		{
			StoreProduct previousValue = this._StoreProduct1.Entity;
			if (((previousValue != value) 
						|| (this._StoreProduct1.HasLoadedOrAssignedValue == false)))
			{
				this.SendPropertyChanging();
				if ((previousValue != null))
				{
					this._StoreProduct1.Entity = null;
					previousValue.StoreProductRelations1.Remove(this);
				}
				this._StoreProduct1.Entity = value;
				if ((value != null))
				{
					value.StoreProductRelations1.Add(this);
				...
				this.SendPropertyChanged("StoreProduct1");
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreProduct_StoreProductRelation1", Storage="_StoreProduct", ThisKey="RelatedProductID", OtherKey="ID", IsForeignKey=true)]
	public StoreProduct StoreProduct
	{
		get
		{
...
public partial class CMSPage : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	public CMSPage CMSPage1
	{
		...
		set
		{
						...
						|| (this._CMSPage1.HasLoadedOrAssignedValue == false)))
			{
				...
				this.SendPropertyChanged("CMSPage1");
			}
		}
	}
	...
	{
		this.SendPropertyChanging();
		entity.CMSPage1 = this;
	}
	
	private void detach_CMSPages(CMSPage entity)
	{
		this.SendPropertyChanging();
		entity.CMSPage1 = null;
	}
...
public partial class FilterItem : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StoreCharacter_FilterItem", Storage="_StoreCharacter", ThisKey="CharID", OtherKey="ID", IsForeignKey=true, DeleteRule="CASCADE")]
	public StoreCharacter StoreCharacter
	{
		...
		set
		{
						...
						|| (this._StoreCharacter.HasLoadedOrAssignedValue == false)))
			{
				...
				{
					value.FilterItems.Add(this);
					this._CharID = value.ID;
				}
				else
				{
					this._CharID = default(Nullable<int>);
				}
