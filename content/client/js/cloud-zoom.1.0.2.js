...
/* Add a box (mouseTrap) over the small image to trap mouse events.
		...
		*/
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
                ...
                zoomDiv = appendTo.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:%0px;top:%1px;width:%2px;height:%3px;background-image:url(\'%4\');z-index:20;"></div>', xPos, yPos, w, h, zoomImage.src)).find(':last');
        ...
        this.each(function () {
            ...
            if ($(this).is('.cloud-zoom')) {
                ...
                $(this).bind('click', $(this), function (event) {
                    ...
                    $('#' + data.useZoom).attr('arg', event.data.attr('arg'));
